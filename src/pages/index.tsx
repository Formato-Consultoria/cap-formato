        ...
        <main className='flex flex-col'>
            <section className={"flex items-center justify-center gap-10 md:gap-24 md:px-3 pt-20 pb-10"}>
                <div className={"flex flex-col w-full md:w-2/5 px-5 md:p-0"}>
                    ...
                    <p className={"text-lg font-sans font-light text-center md:text-left text-orange-200/70"}>Com nosso guia de receitas de hamburgers artesanais, aprenda a preparar combinações incríveis de ingredientes e técnicas que transformarão suas criações culinárias. Experimente agora mesmo e descubra novos sabores!</p>
                </div>
            ...
            <section className={cx(
                "h-auto w-full bg-orange-300 flex gap-2 py-3 md:py-10 px-3 md:px-10 lg:px-24",
            )}>
                <div className={"flex items-center justify-center relative py-10 px-5 rounded-2xl h-96 w-full"}>
